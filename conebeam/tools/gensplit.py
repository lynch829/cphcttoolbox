...
# --- BEGIN_HEADER ---
#
# gensplit - cone beam projection splitter
...
"""Generate split projs from cone beam projection files"""

import sys

from cphct.cone.conf import default_cone_npy_conf, default_cone_npy_opts, \
    enable_conf_option, enable_conf_option, engine_opts, engine_conf, \
...
def core_tool(projs, conf, tool_state):
    ...
    # Just leave the chunk alone for save to auto split

    return projs


def main(conf):
    """Generate split projs
