...
# --- BEGIN_HEADER ---
#
# genfanslices - cone beam projection center fan slice generator
...
"""Generate center slices from full cone beam projection files"""
...
def init_tool(conf):
    ...
    # Force center slice - include last item

    conf['first_row'] = conf['last_row'] = 0.5 \
                        * float(conf['detector_rows'] - 1)

    if conf['last_column'] < 0:
        conf['last_column'] = conf['detector_columns'] - 1
