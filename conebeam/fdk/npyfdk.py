...
# --- BEGIN_HEADER ---
#
# npyfdk - NumPy fdk reconstruction
...
"""Circular cone beam CT using the FDK algorithm in NumPy"""
...
from cphct.cone.fdk.conf import default_fdk_npy_conf, \
    default_fdk_npy_opts, parse_setup, ParseError
from cphct.cone.fdk.npy.io import fill_fdk_npy_conf
from cphct.cone.fdk.npycore.kernels import init_recon, reconstruct_proj

app_names = ['fdk', 'npyfdk']
...
if __name__ == '__main__':
    npy_cfg = default_fdk_npy_conf()
    npy_opts = default_fdk_npy_opts()
    try:
