...
# --- BEGIN_HEADER ---
#
# io - katsevich specific input/ouput helpers
...
"""Katsevich specific input/output helper functions"""

from cphct.conf import allowed_values, allowed_scanning_paths

def fill_katsevich_conf(conf):
    ...
    conf['scanning_path'] = allowed_values('helix', allowed_scanning_paths)
