...
# --- BEGIN_HEADER ---
#
# __init__ - miscellaneous OpenCL helper functions shared by all modules.
...
"""Cph CT Toolbox miscellaneous OpenCL helper functions shared by all modules"""
...
from cphct.cl.misc.base import gpuarray_copy, gpuarray_square
