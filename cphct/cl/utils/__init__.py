...
# --- BEGIN_HEADER ---
#
# __init__ - OpenCL back end functions shared by plugin and tools
...
"""Cph CT Toolbox OpenCL back end functions shared by plugins and tools.
...
# Functions available through cphct.cl.utils

from cphct.cl.utils.base import prepare_output, square_array
