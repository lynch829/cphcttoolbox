...
# --- BEGIN_HEADER ---
#
# __init__ - Back end functions shared by plugins and tools.
...
# Functions available through from cphct.utils

from cphct.utils.base import transfer_missing_metadata
